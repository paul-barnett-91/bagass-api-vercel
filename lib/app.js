...
const ENDPOINTS = [
  ...
  { method: "POST", path: "/api/games", description: "Create a game (requires auth)" },
  { method: "GET", path: "/api/games/:id", description: "Fetch a single game" },
  {
    method: "PUT",
    path: "/api/games/:id",
    description: "Update a single game (requires auth)",
  },
  { method: "GET", path: "/api/players", description: "List all players" },
  {
    method: "POST",
    path: "/api/players",
    description: "Create a player (requires auth)",
  },
  {
    method: "GET",
    path: "/api/players/:id",
  ...
  },
  {
    method: "PUT",
    path: "/api/players/:id",
    description: "Update a single player (requires auth)",
  },
  {
    method: "GET",
  ...
  },
  {
    method: "POST",
    path: "/api/game_plays",
    description: "Create a game play, optionally with its results (requires auth)",
  },
  {
    method: "PUT",
    path: "/api/game_plays/:id",
    description: "Add/update notes, moment, and/or results on a game play (requires auth)",
  },
  {
    method: "GET",
  ...
  },
  {
    method: "POST",
    path: "/api/auth/login",
    description: "Log in with username/password, returns a JWT",
  },
  {
    method: "POST",
    path: "/api/auth/set-password",
    description: "Set a user's password (requires auth)",
  },
];
